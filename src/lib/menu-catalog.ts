...
export const MENU_CATALOG: MenuEntry[] = [
  ...
  { slug: "agenda.atividades", label: "Agenda — Atividades", category: "main" },
  { slug: "agenda.timeline", label: "Agenda — Timeline", category: "main" },
  ...
  { slug: "config.robo-atendimento", label: "Robô de Atendimento", category: "config" },
...
export const URL_TO_MENU_SLUG: Record<string, string> = {
  ...
  "/agenda/atividades": "agenda.atividades",
  ...
  "/configuracoes/robo-atendimento": "config.robo-atendimento",
